package com.android.narayana.bloodbank.activities;
...
import com.android.narayana.bloodbank.R;
import com.android.narayana.bloodbank.viewmodels.CustomUserData;
import com.android.narayana.bloodbank.viewmodels.UserData;
                        ...
                        findname.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    CustomUserData customUserData = new CustomUserData(text2.getText().toString(),spinner2.getText().toString().toLowerCase(),text1.getText().toString(),dataSnapshot.getValue(UserData.class).getName(),spinner1.getSelectedItem().toString(),Time,Date);
                                    db_ref.child(uid).push().setValue(customUserData);
